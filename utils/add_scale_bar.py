## author: xin luo
## creat: 2024.12.20  # modify: xxxx
## des: add scale bar to the map


import numpy as np
import cartopy.crs as ccrs

def add_scale_bar(ax, length=None, tmc = ccrs.Mercator(), 
                  loc=(0.5, 0.05), linewidth=3, color_bar='black', color_text='black'):
    """
    params:
    ...
    #Plot the scalebar
    ax.plot(bar_xs, [sby, sby], transform=tmc, color=color_bar, linewidth=linewidth)
